 <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="\architecture\admin\index.php">
                    <i class="fas fa-fw fa-tachometer-alt"></i>
                    <span>Tableau de bord</span></a>
            </li>
            <li class="nav-item active">
                <a class="nav-link" href="Afficher_user.php">
            ...
            <li class="nav-item">
                ...
                <div id="collapseSercices" class="collapse" aria-labelledby="Services" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="Ajouter_service.php">Ajouter article  </a>
                        <a class="collapse-item" href="Afficher_service.php">Afficher article </a>
                    </div>
                </div>
            </li>
            <li class="nav-item">
